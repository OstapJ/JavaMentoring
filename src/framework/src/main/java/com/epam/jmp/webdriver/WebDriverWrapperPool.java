...
public class WebDriverWrapperPool extends BrowserPool implements WebDriver
{
	...
	public synchronized WebDriverWrapperPool getInstance(String name, WebDriverFactory webDriverFactory)
			throws Exception
	{
	...
	{
		LOGGER.info(
				"Create WebDriverWrapper instance with name '" + browserName + "' using " + webDriverFactory.getClass()
						.getSimpleName()
	...
	public void quitAll()
	{
		...
		{
			LOGGER.debug("Closing WebDriverWrapper. Size is '{}'" + WebDriverWrapper.getBrowserName(),
					AllBrowserInstances.size());
